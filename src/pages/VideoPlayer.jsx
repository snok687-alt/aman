...
<div className="bg-gray-900 min-h-screen">
  <div className="max-w-7xl mx-auto lg:p-6 text-white">
    ...
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <div className="w-full lg:w-12/12">
        ...
        {/* Video Info Section */}
        <div className="mt-4 mx-1 bg-gray-800 p-4 rounded-lg">
      ...
      <div className="w-full lg:w-5/12 overflow-y-auto max-h-[70vh] lg:max-h-[calc(100vh-80px)] lg:sticky top-4">
        <div className="rounded-lg p-3 bg-gray-800 lg:bg-transparent">
          <h3 className="text-xl font-bold mb-4 py-3 z-10 bg-gradient-to-r from-gray-900 to-transparent pl-2 lg:sticky top-0">
            วิดีโอที่เกี่ยวข้อง
          </h3>
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-1 gap-4 pr-2">
            {relatedVideos.map((relatedVideo) => (
              <div key={relatedVideo.id} className="transform transition-transform duration-300 hover:scale-105">
                <VideoCard video={relatedVideo} onClick={handleVideoClick} />
              </div>
            ))}
          </div>
        </div>
